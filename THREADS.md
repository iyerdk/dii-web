...
Beat: Connectivity
Status: active
Summary: 17 cables disrupted via Red Sea corridor with no repair timeline; Iran formalised regulatory mandate requiring permits, annual fees, and exclusive maintenance rights for 7 Hormuz cables; Italy acquired TIM Sparkle (EC-cleared, €700M) — Rome takes direct state control of Mediterranean routing infrastructure; EU committed €347M to submarine cable security — €180M CEF backbone call for 13 Cable Projects of European Interest (June 30, 2026 deadline), €20M smart cable monitoring, €20M Baltic Sea emergency repair; Cable Security Toolbox released; GUIDE launched May 30 at Shangri-La Dialogue — 17 nations (7 EU member states + UK + Indo-Pacific partners) in first cross-regional military/intelligence information-sharing framework for undersea cable security; UK Defence Secretary disclosed tracking 3 Russian submarines surveying North Atlantic cable routes; FCC voted unanimously 3-0 on June 25, 2026 to adopt Second R&O — SLTE licensing bars Huawei/ZTE/HMN Technologies from US cable-landing equipment; Nokia Submarine Networks/Subcom/Alcatel Submarine Networks are sole eligible SLTE suppliers; Team Telecom fast-track for high-security cables; Further NPRM opens on expanded FCC authority; three-layer governance architecture operationally complete: EU Cable Security Toolbox (civilian), GUIDE (military/intelligence), FCC SLTE order (equipment); $10 trillion in daily financial transactions transit the named Hormuz cables; Medusa ViaTunisia activated June 8 — 1,050km Marseille-to-Bizerte, first live leg of €342M 10-country Mediterranean system (AFR-IX/Orange/EU); Marseille reaches 17 cable landings (Europe's densest Mediterranean hub); 8 additional Medusa landings planned across Egypt, Greece, Cyprus, Italy, Spain, Morocco, Portugal, Algeria in 2026; I-2SEA construction contracts signed July 4, 2026 (Lightstorm/Microsoft/Singtel/Tata) — first cable explicitly designed for AI training/GPU cluster traffic, bypasses Red Sea/Hormuz/Suez, India to Singapore and Kuala Lumpur; subsea cable architecture bifurcating into AI-native and standard internet specifications.
Changelog:
...
- Edition 18 (2026-06-25): Medusa ViaTunisia segment activated June 8 — 1,050km Marseille-to-Bizerte, first live leg of €342M 10-country Mediterranean system (AFR-IX Telecom lead, Orange co-funder, Alcatel Submarine Networks supplier); Marseille reaches 17 cable landings (Europe's densest Mediterranean hub); Orange integrates ViaTunisia directly into Paris-region DC fibre ring — new capacity immediately available to wholesale customers; full Medusa system: 8,760km, 10 countries, 16 landing points, 24 fibre pairs at 20 Tbps per pair; 8 additional landings planned across Egypt, Greece, Cyprus, Italy, Spain, Morocco, Portugal, Algeria in 2026
- Edition 19 (2026-07-02): FCC voted unanimously 3-0 on June 25 to adopt Second R&O on submarine cable landing licences — SLTE licensing bars Huawei/ZTE/HMN Technologies from US cable-landing hardware; Nokia Submarine Networks, Subcom, Alcatel Submarine Networks are sole eligible SLTE suppliers; Team Telecom fast-track for high-security-certified cables; three-layer governance architecture operationally complete (EU Cable Security Toolbox + GUIDE + FCC SLTE); Further NPRM opens on expanding FCC cable authority; next watch: Ofcom or EC equivalents to SLTE hardware control at European landing points
- Edition 20 (2026-07-09): I-2SEA construction contracts signed July 4, 2026 — Lightstorm (lead), Microsoft, Singtel, Tata Communications; India to Singapore and Kuala Lumpur; entirely bypasses Red Sea, Hormuz Strait, and Suez Canal; first publicly documented cable explicitly designed for AI training/GPU cluster traffic (low jitter, high capacity for large data packet workloads); no European landing point; subsea cable architecture bifurcating between AI-native and standard internet specifications; watch for Lightstorm/consortium European leg announcement connecting I-2SEA India landings to EMEA
...
- Edition 18 (2026-06-25): EU Horizontal Merger Guidelines consultation closed June 26 — first rewrite in 22 years; draft abandons 2-year investment benefit horizon and codifies "loss of investment competition" as standalone theory of harm for 4→3 consolidations; Bouygues (France's most aggressive mobile investor) absorption is the direct application case; GSMA + ETNO submitted responses calling for investment productivity test (if adopted, shifts framework toward permissiveness); final guidelines adoption Q4 2026; SFR formal pre-notification H2 2026 creates strategic race between framework finalisation and filing — filing before adoption triggers more permissive 2004 rules
...
Beat: UK & Ireland
Status: active
Summary: OpenAI paused Stargate UK citing industrial electricity at 24.67p/kWh (~4x US rates); UK secured NSIP opt-in for large data centres (bypasses local planning authorities, aligns consent with energy infrastructure delivery); Ofcom to gain cybersecurity oversight of data centres via Cyber Security and Resilience Bill; Ofgem Phase 1 demand connection reform (data centres the explicit focus): financial gatekeeping proposed — refundable deposits, commitment fees, FID evidence, planning permission as queue entry conditions; UK demand queue tripled to 125 GW with ~50 GW linked to data centres (~140 DCs in queue, only 71/~20 GW at FID); tCSNP2 transmission plan refresh due June 2026; energy pricing gap vs Nordic and US markets remains unaddressed by all proposed reforms; UK designated 5 AI Growth Zones June 8 — Culham, North East England, North Wales, South Wales, Lanarkshire; Nscale £2.5B (Loughton Essex, 45,000 GB200 GPUs, Q4 2026) + Vantage £12B (Bridgend former Ford plant, 10 buildings, 11,500 jobs) as first anchors; Lanarkshire backed by £8.2B committed private investment; Growth Zone designation addresses planning only — 24.67p/kWh electricity and 125GW Ofgem queue unchanged; Elsham Tech Park (North Lincolnshire AI Growth Zone) granted outline planning permission — 1GW, 176 hectares, 15 hyperscale data halls, £10B investment, construction 2027, Phase 1 2029; first concrete proof of Growth Zone fast-track delivering outside M25/South East cluster; Gate 2 grid connection offer and tCSNP2 corridor confirmation are next structural milestones.
Changelog:
...
- Edition 18 (2026-06-25): UK designates 5 AI Growth Zones June 8 — Culham (Oxfordshire), North East England, North Wales, South Wales, Lanarkshire (Scotland, £8.2B committed); Nscale £2.5B (Loughton Essex, 45,000 NVIDIA GB200 GPUs, Q4 2026) + Vantage £12B (Bridgend former Ford plant, 10 buildings, 11,500 jobs) confirmed as first anchors; Nscale dual UK/Norway footprint confirms bifurcation thesis (Norway for training at €0.04/kWh, UK for latency/compliance); 24.67p/kWh electricity, 125GW Ofgem queue, and tCSNP2 timeline unchanged by Growth Zone designation
- Edition 20 (2026-07-09): North Lincolnshire Council grants outline planning permission for Elsham Tech Park — 1GW compute, 176 hectares, 15 hyperscale data halls, £10B investment, 900–1,200 permanent roles, construction 2027, Phase 1 2029; first concrete proof AI Growth Zone fast-track delivers outside M25/South East; ~50MW on-site generation planned; 24.67p/kWh and 125GW Ofgem queue unchanged; tCSNP2 has not confirmed North Lincolnshire transmission corridor; Gate 2 connection offer required before 2027 construction start; environmental challenge on planning submission carbon calculations filed

## thread-id: nordics-infra-advantage
Beat: Nordics
Status: active
Summary: Nordics satisfy all three AI infrastructure criteria simultaneously — low power cost (Norway ~€0.03–0.04/kWh, Sweden ~€0.05/kWh), grid access, and regulatory predictability; Nscale's Narvik campus ($4.2B total capital, $790M infrastructure debt, Eksfin/state backing, Microsoft 30,000+ Rubin GPUs) confirms Norway as Europe's AI compute anchor; atNorth NOR01 (Haugaland, 350MW, $1.1B Phase 1, CPP Investments 60%/Equinix 40%, Statnett dedicated substation, 2028) raises Norway's total announced AI hyperscale pipeline to ~580MW; EQT launched €8B GlobalConnect sale (Telenor fragmenting via NOK 6B Norway consumer acquisition); DTCP acquired Dark Fiber Group; advantage sharpens vs Ireland CRU generation obligation, UK's 24.67p/kWh, and Germany's ERF paradox (Nordic district heating networks at 70–80°C are best-positioned for ERF compliance with lowest heat pump uplift); Telenor subsidiary KNL awarded UK £5.4B military HF comms framework RM6393 June 25 — Nordic operators expanding dual-use infrastructure revenue as €50B Nordic defence spend (2026, +30% from 2020) creates a second structural revenue pillar alongside AI compute; ETNA Capital (Copenhagen) — €220M anchored by PensionDanmark €100M, AP Pension €70M, AkademikerPension €50M — formalises institutional capital for dual-use Nordic/Baltic assets; first acquisition Brolis Defence Group (Vilnius, Lithuania) closed May 7, 2026; FDPP launched by Insurance & Pension Denmark as standardised financing framework.
Changelog:
...
- Edition 19 (2026-07-02): Germany ERF paradox (liquid cooling 35–45°C vs district heating 70–90°C) further sharpens Nordic advantage — existing Nordic district heating networks and lower ambient temperatures reduce heat pump differential for ERF compliance; Telenor subsidiary KNL awarded UK £5.4B military HF comms framework RM6393 June 25 — Nordic operators gaining dual-use defence revenue alongside AI compute; Nordic states spending €50B on defence in 2026 (+30% from 2020)
- Edition 20 (2026-07-09): ETNA Capital (Copenhagen, est. December 2025) secures €220M anchor from PensionDanmark €100M, AP Pension €70M, AkademikerPension €50M — former ESG-exclusion funds formalising defence as mandatory allocation; first acquisition Brolis Defence Group (Vilnius) closed May 7, 2026 — largest Baltic PE defence deal; FDPP (Insurance & Pension Denmark + Finance Denmark) launches standardised defence financing framework; PFA defence funds attracted DKK 650M from retail customers; Nordic dual-use thesis institutionalised with patient capital across AI compute, HF comms, and electro-optical sensing

## thread-id: globalconnect-sale
Beat: Nordics
Status: active
Summary: EQT targeting €8B sale of GlobalConnect via Goldman Sachs — 244,000km fibre across Denmark, Norway, Sweden, Germany, Finland; 23 data centres, 27 subsea cables, 30,000 business customers; Antin Infrastructure Partners among early bidders; Telenor acquired GlobalConnect's Norwegian consumer fibre business (NOK 6B/~€530M, NCA-approved June 8, 125,000 subscribers) and Enivest (Western Norway ISP, June 10) — fragmenting EQT's integrated platform thesis; residual asset is B2B fibre, 23 DCs, 27 subsea cables; first-round bids remain the next formal process milestone.
Changelog:
...
- Edition 19 (2026-07-02): Telenor acquires GlobalConnect Norwegian consumer fibre business for NOK 6B (~€530M) — NCA-approved June 8; 125,000 subscribers transferred, ~6,000 at overlap addresses divested to third provider; wholesale open-access condition on acquired fibre; Telenor also acquires Enivest (Western Norway ISP) June 10; EQT €8B unified sale thesis materially fragmented — B2B/DC-only perimeter likely; thread moved back to active

## thread-id: hyperscaler-capex-supercycle
Beat: Data Infrastructure
Status: active
Summary: Combined 2026 hyperscaler capex revised to $785B (Moody's) — $60B above prior $725B consensus; Moody's projects approaching $1 trillion in 2027; Q1 2026 optical DC interconnect equipment purchases up 50% YoY; individual guidance: Microsoft $190B, Amazon $200B, Alphabet $180–190B, Meta $125–145B; Blackstone committed $5B equity to Google TPU JV (total $25B with leverage); aggregate institutional private capital committed to AI infrastructure platforms exceeds $75B; Meta Compute announced July 1, 2026 — cloud business to sell surplus EU data centre capacity (Netherlands, Denmark, Ireland) to external enterprise customers, competing with AWS, Azure, and Google Cloud; product model (raw IaaS vs hosted AI models) TBD; Meta stock +6–10% on announcement.
Changelog:
...
- Edition 20 (2026-07-09): Meta announces Meta Compute — cloud business to sell surplus EU data centre capacity (Netherlands/Odense/Zeewolde, Denmark, Ireland) to external enterprise customers; led by Santosh Janardhan, Daniel Gross, Dina Powell McCormick; product model (raw IaaS vs hosted AI models) unresolved; EU-domiciled footprint under GDPR/DMA adds sovereignty angle vs CLOUD Act-exposed rivals; Meta stock +6–10% on July 1 Bloomberg report
...
- Edition 20 (2026-07-09): Thread closed — no development in 6 consecutive editions (15–20); judicial review hearing timeline 12–18 months from April 28, 2026 leave grant; reopen on hearing date announcement, new CRU connection approval, or policy revision
...
- Edition 20 (2026-07-09): Thread closed — dormant for 5 consecutive editions (16–20); reopen on first European campus announcement, additional capital raise, or named hyperscaler partnership disclosure
...
- Edition 20 (2026-07-09): Thread closed — dormant for 5 consecutive editions (16–20); reopen on formal announcement of intent, deal structure filing, or confirmed termination of talks
...
- Edition 20 (2026-07-09): Thread closed — no development in 7 consecutive editions (14–20); reopen on first hyperscaler pre-lease announcement, Italian grid connection offer, or Phase 2 campus announcement

## thread-id: european-cable-sovereignty
Beat: Connectivity
Status: active
Summary: Italian MEF + Retelit (Cellnex-owned) acquired TIM Sparkle for €700M (EC-cleared April 13, 2026, no conditions) — Italy takes direct state control of Mediterranean subsea routing; US OFAC/FCC clearance pending Q2 2026; part of a pattern: France (Altice SFR oversight), Germany (Huawei/ZTE removal mandate), Italy (Sparkle acquisition) — three European state-level interventions in strategic telecom infrastructure in 2026, none blocked by EC competition law; Medusa ViaTunisia activation (June 8) brings Marseille to 17 cable landings — France establishes rival Mediterranean cable concentration to Italy's TIM Sparkle routing control; dual sovereign concentrations now in play: Italian state holds routing contracts, French infrastructure holds landing-point density.
Changelog:
...
- Edition 18 (2026-06-25): Medusa ViaTunisia activation brings Marseille to 17 cable landings — France establishes rival Mediterranean cable concentration; AFR-IX/Orange €342M system creates alternative backbone independent of TIM Sparkle routes; dual sovereign concentrations now active in Mediterranean cable infrastructure
...
- Edition 20 (2026-07-09): Thread closed — no development in 6 consecutive editions (15–20); reopen on new EU DC PPA transaction >500MW, material improvement in offshore wind capture rates, or Q2 2026 PPA volume data release
...
- Edition 20 (2026-07-09): Thread closed — no development in 5 consecutive editions (16–20); reopen on RTE grid connection application, PPA disclosure, construction permit filing, or Phase 1 groundbreaking at Dunkirk/Loon-Plage

## thread-id: eu-ai-gigafactory
Beat: Data Infrastructure
Status: active
Summary: EU's €20B AI gigafactory initiative (5 sovereign AI data centres) facing structural confidence failure — bidder pool collapsed from ~70 expressions of interest to ~10 formal bids; EuroHPC deadline June 23, 2026 closed; 3–5 designations expected July 2026; only €4.1B of €20B has confirmed EU funding; €15.9B member state and private co-investment has not materialised; AION consortium (Ardian, Artefact, Bull/Atos, Capgemini, EDF, Iliad, Orange, Scaleway) submitted €10B bid June 5 — 200MW by 2030, 1GW total, EDF nuclear + RTE grid connection as power differentiator; Schwarz Group building 200+ MW south of Berlin independently; bilateral investment structures (SoftBank France €75B, Ardian/Verne €5B private campus) pre-empting the sovereign capacity rationale.
Changelog:
...
- Edition 18 (2026-06-25): AION consortium (Ardian, Artefact, Bull/Atos, Capgemini, EDF, Iliad, Orange, Scaleway) submits €10B bid June 5 — 200MW Phase 1 by 2030, 1GW total, compute equivalent to 288,000+ NVIDIA H100 GPUs; EDF nuclear baseload + RTE grid connection as power strategy; EuroHPC June 23 deadline closed; 3–5 designations expected July 2026 from ~10 formal bids; France already holds SoftBank €75B bilateral and Ardian/Verne €5B private campus — EU designation value is open-access mandate, not primary capital source
...
- Edition 20 (2026-07-09): Thread moved to dormant — no development in 4 consecutive editions (17–20); next expected milestone is first hyperscaler pre-lease announcement or Phase 1 construction milestone at PAR01/PAR02, FRA02, or AMS01

## thread-id: ardian-france-dc-platform
Beat: Western Europe
Status: active
Summary: Ardian and Verne announced €5B, 500MW AI and computing campus in Île-de-France at Choose France summit June 1, 2026 — 200MW Phase 1 by 2030, Verne's first France project; no EU subsidy or named hyperscaler anchor (fully private capital track); Ardian vertically integrated across campus equity (Verne JV), energy supply (Akuo + GreenYellow renewables subsidiaries, €3B committed, 2.5GW by 2030), and workload origination (AION EU gigafactory consortium); three-layer vertical — infrastructure, power, workload — most integrated private-capital AI DC thesis in Western Europe; ~€10M/MW capital intensity at Paris-region scale; first hyperscaler or enterprise pre-lease and Akuo/GreenYellow delivery timeline are next milestones.
Changelog:
- Edition 18 (2026-06-25): Ardian + Verne announce €5B, 500MW Île-de-France AI campus at Choose France summit — 200MW Phase 1 by 2030; no EU subsidy or public anchor; Ardian simultaneously manages campus equity (Verne), energy supply (Akuo/GreenYellow €3B, 2.5GW), and workload access (AION gigafactory consortium); Verne's first France project; positions as Paris-latency competitor to Equinix and Digital Realty FLAP-D strongholds

## thread-id: eu-dc-efficiency-standards
Beat: Energy & Power
Status: active
Summary: Germany Energy Efficiency Act triggers PUE ≤1.2 AND ERF ≥10% for all new data centres commissioned from July 1, 2026 — first hard dual EU member-state efficiency threshold; ERF paradox documented: AI liquid cooling operates at 35–45°C vs 70–90°C district heating injection threshold — heat pump/exchanger infrastructure required for ERF compliance, adding costs beyond the already-flagged €5–15M liquid cooling premium per 50MW build; ERF escalates ≥15% (July 2027) and ≥20% (July 2028); Germany January 2027 follow-on: 100% renewable electricity mandatory for all German data centres; EC finalised EED delegated regulation establishing 24-KPI EU-wide public labelling scheme via European Database on Data Centres; France, Netherlands, Ireland, Belgium monitoring Germany as reference point before legislating equivalent hard thresholds; Nordic climate conditions and existing district heating networks make ERF compliance structurally easier than any FLAP-D market.
Changelog:
- Edition 18 (2026-06-25): Germany PUE ≤1.2 mandate triggers July 1, 2026 — first hard EU data centre efficiency threshold; liquid cooling required for all new German builds (€5–15M premium on 50MW vs air-cooled baseline); January 2027 German follow-on: 100% renewables mandatory; EC finalised EED delegated regulation: 24-KPI EU-wide labelling including PUE/WUE/ERF/REF public scores via European Database on Data Centres; France, Netherlands, Ireland, Belgium monitoring Germany before legislating equivalents
- Edition 19 (2026-07-02): ERF ≥10% dual mandate confirmed live July 1 alongside PUE ≤1.2; ERF paradox documented — AI liquid cooling at 35–45°C incompatible with 70–90°C district heating injection; heat pump/exchanger infrastructure required for high-density AI builds; ERF escalator to ≥15% (July 2027) and ≥20% (July 2028) confirmed; first German planning applications post-July 1 are the next empirical ERF compliance data point
- Edition 20 (2026-07-09): ERF compliance cost quantified — heat pump/exchanger infrastructure adds €5–15M to a 50MW AI-dense build beyond the liquid cooling premium; BAFA RZReg annual reporting live; non-compliance penalties €50K–€100K per infraction; January 2027 German follow-on: 100% renewable electricity mandatory; France, Netherlands, Ireland, Belgium monitoring Germany's first post-July 1 planning applications as legislative benchmark; Nordic district heating at 70–80°C structurally advantaged vs any FLAP-D market for ERF compliance

## thread-id: digitalbridge-arclight
Beat: Capital & Deals
Status: active
Summary: DigitalBridge Group agreed May 27, 2026 to acquire ArcLight Capital Partners for up to $1.05B ($650M base + $400M contingent) — combining 20.8 GW of operating power generation (predominantly PJM, 7 GW overlapping major US DC clusters) with DigitalBridge's digital infrastructure platform; combined AUM $150B+; formalises power access as the defining competitive moat in AI infrastructure fund management; deal closes H2 2026; ArcLight portfolio is North American; European equivalent platform (DC assets + owned renewable generation) has not yet emerged.
Changelog:
- Edition 19 (2026-07-02): DigitalBridge agrees to acquire ArcLight Capital Partners for up to $1.05B ($650M base + $400M contingent), announced May 27, 2026; 20.8 GW operating power (FERC filing), 15 GW development pipeline, predominantly PJM; combined AUM $150B+; watch: KKR Helix or Blackstone analogous European power-plus-digital acquisition before 2027

## thread-id: pantheon-croatia-dc
Beat: Western Europe
Status: active
Summary: Transatlantic Investment Group / Pantheon Atlas LLC announced April 28, 2026: €50B AI data centre campus in Topusko, Croatia — 1 GW capacity / 800 MW IT load, NVIDIA GW Scale AI Factory spec, 310 acres near Zagreb; 500 MW solar PV + 8,000 MWh BESS from Greenvolt/KKR (LOI signed) in fully behind-the-meter configuration; €12B construction cost; construction begins early 2027, full operation Q1 2029; no named hyperscaler anchor tenant; first GW-scale CEE data centre proposal and most explicit European BTM power proof-of-concept.
Changelog:
- Edition 19 (2026-07-02): Pantheon AI €50B / 1GW Croatia campus announced April 28, 2026 (first DII coverage); Greenvolt/KKR LOI for 500MW solar + 8,000MWh BESS; behind-the-meter energy strategy bypasses Croatian grid connection; no hyperscaler anchor named; watch: Greenvolt LOI conversion to binding contract and hyperscaler pre-lease before 2027 construction start

## thread-id: knl-uk-defence
Beat: Nordics
Status: active
Summary: Telenor subsidiary KNL (Finnish HF communications specialist) awarded approved supplier status on UK Tactical Communication Systems Framework RM6393, June 25, 2026 — combined ceiling £5.4B over 8 years (£4.7B Lot 2 Systems + £727M Lot 3 Components); KNL appointed for both lots; individual contracts competed as call-offs; framework runs through 2034; reflects €50B Nordic defence spend in 2026 (+30% from 2020); ETNA Capital (€220M, PensionDanmark/AP Pension/AkademikerPension) and FDPP framework formalise institutional capital structure for Nordic/Baltic dual-use assets — Brolis Defence Group (Lithuania, electro-optical/laser/infrared sensing) is ETNA's first acquisition; Nordic dual-use infrastructure thesis now backed by sovereign procurement (KNL/RM6393), pension capital (ETNA/FDPP), and physical infrastructure (Nscale Narvik, atNorth NOR01).
Changelog:
- Edition 19 (2026-07-02): KNL awarded RM6393 approved supplier status June 25, 2026; £5.4B framework ceiling over 8 years; KNL in both Lot 2 (Systems) and Lot 3 (Components); Nordic defence spend €50B in 2026 (+30% vs 2020); watch: first call-off awards under RM6393 and whether KNL extends to German/Dutch/Danish NATO procurement frameworks
- Edition 20 (2026-07-09): ETNA Capital €220M fund (PensionDanmark €100M, AP Pension €70M, AkademikerPension €50M) acquires Brolis Defence Group (Vilnius) — laser/electro-optical/infrared sensing for military, border, and critical infrastructure; largest Baltic PE defence deal; FDPP institutional framework launched; Nordea, Danske Bank, Svenska Handelsbanken all launched defence/security funds H2 2025; PFA retail attracted DKK 650M; institutional architecture for dual-use Nordic capital now complete alongside KNL defence procurement revenue

## thread-id: eu-digital-networks-act
Beat: European Telecom
Status: active
Summary: EU Digital Networks Act adopted by European Commission January 21, 2026; now in European Parliament–Council trialogue; proposes indefinite spectrum licences by default (or 40-year maximum with quasi-automatic renewal, vs current 20-year cap) — potentially worth €5–15B per large operator in reduced renewal cost and capital risk; consolidates EECC, BEREC Regulation, Radio Spectrum Policy Programme, and Open Internet Regulation into single framework; EC estimates up to €400B GDP uplift by 2035 from full deployment; GSMA study identifies €205B 5G investment gap (€475B needed, €270B accessible) — spectrum policy is the industry's primary lever; trialogue expected to complete by end-2026, concurrent with SFR pre-notification and EU Merger Guidelines adoption.
Changelog:
- Edition 20 (2026-07-09): First DII coverage — EU Digital Networks Act in parliamentary trialogue; indefinite spectrum (40-year quasi-automatic renewal) is most commercially significant provision; eliminates 20-year licence cliff worth €5–15B per operator in renewal cost risk; GSMA €205B 5G gap framing is industry's benchmark response; trialogue to negotiate EU vs national spectrum authority balance and net neutrality preservation; end-2026 completion concurrent with SFR pre-notification and EU Merger Guidelines adoption — landmark regulatory quarter for European telecom
