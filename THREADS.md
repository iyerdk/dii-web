...
Beat: Energy & Power
Status: active
Summary: Germany Energy Efficiency Act triggers PUE ≤1.2 for all new data centres commissioned from July 1, 2026 — first hard EU member-state performance threshold; liquid cooling now a regulatory requirement for German pipeline projects (estimated €5–15M premium on a 50MW build vs air-cooled baseline); Germany January 2027 follow-on: 100% renewable electricity mandatory for all German data centres; EC finalised EED delegated regulation establishing 24-KPI EU-wide public labelling scheme (PUE, WUE, ERF, REF) via European Database on Data Centres (facilities ≥500kW IT load); France, Netherlands, Ireland, Belgium monitoring Germany as reference point before legislating equivalent hard thresholds.
Changelog:
